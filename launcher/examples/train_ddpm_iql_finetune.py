...
def main(_):
    constant_parameters = {
        ...
        "training_time_inference_params": {"N": 64, "clip_sampler": True, "M": 0},
        "rl_config": {
            ...
            "decay_steps": int(
                2e6
            ),  # Change this to int(4e6) for (2) (because you are finetuning actor)
